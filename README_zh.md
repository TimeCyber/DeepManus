...
- [架构](#架构)
- [功能特性](#功能特性)
- [为什么选择 DeepManus？](#为什么选择-DeepManus)
- [安装设置](#安装设置)
    - [前置要求](#前置要求)
    - [安装步骤](#安装步骤)
    - [配置](#配置)
...
![DeepManus 架构](./assets/architecture.png)
...
DeepManus 使用 [uv](https://github.com/astral-sh/uv) 作为包管理器以简化依赖管理。
...
DeepManus 使用三层 LLM 系统，分别用于推理、基础任务和视觉语言任务，使用项目根目录下conf.yaml进行配置，您可以复制`conf.yaml.example`到`conf.yaml`开始配置：
```bash
...
请参考 [DeepManus/DeepManus-web](https://github.com/DeepManus/DeepManus-web) 项目了解更多信息。
...
- [Browser-use](https://pypi.org/project/browser-use/)：提供浏览器控制能力
- [LangManus](https://github.com/LangManus/LangManus)：该项目基于LangManus
